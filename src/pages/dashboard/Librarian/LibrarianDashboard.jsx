...
// Neutral: gray-50 / white (light) | gray-950 / gray-900 (dark)
...
const KpiCard = ({ label, value, icon, gradient, sub }) => (
  <div className="rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-5 shadow-sm hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
...
const Modal = ({ title, onClose, children }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
    <div
      ...
      onClick={onClose}
    />
    <div className="relative w-full max-w-lg bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-200">
...
export default function LibrarianDashboard() {
  ...
  const [editModal, setEditModal] = useState(null); // book object
  ...
  const handleReturnSubmit = async (e) => {
    ...
    try {
      ...
      console.log(error?.response?.data); // 👈 VERY IMPORTANT for debugging
        ...
        >
          <form onSubmit={handleReturnSubmit} className="space-y-4">
            ...
            <InputField
              ...
              // onChange={(e) => setReturnForm({ issue_id: e.target.value })}
              onChange={(e) =>
                setReturnForm((prev) => ({
                  ...prev,
